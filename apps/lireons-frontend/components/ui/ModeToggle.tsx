    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon" className="border-slate-700 bg-slate-900 hover:bg-slate-800 text-cyan-400">
            ...
            <DropdownMenuContent align="end" className="bg-slate-900 border-slate-700 text-slate-300">
                ...
                <DropdownMenuItem onClick={() => setTheme("dark")} className="hover:bg-slate-800 focus:bg-slate-800 cursor-pointer">
                    Dark
                </DropdownMenuItem>
