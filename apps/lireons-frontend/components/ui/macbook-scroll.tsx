...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-screen shrink-0 transform flex-col items-center justify-start perspective-midrange 
      scale-[0.50] pt-24 
      sm:scale-[0.85] sm:pt-32 
      md:scale-100 md:py-80"
    >
      <motion.h2
        style={{
...
const AceternityLogo = () => {
  return (
    <div>
      <Image src="/logo.png" alt="lireons" width={50} height={50}></Image>
    </div>
  );
};